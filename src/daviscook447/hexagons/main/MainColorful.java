...
// Makes the output colorful by generating noise on three channels, one for red, green, and blue
public class MainColorful {
	...
	public static final String DEFAULT_OUT_FILE_PATH = "output/perlin_noise_hexagons_colorful_osx_desktop." + IMAGE_FORMAT;
